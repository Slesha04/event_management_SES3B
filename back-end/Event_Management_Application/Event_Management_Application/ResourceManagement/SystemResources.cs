namespace Event_Management_Application.ResourceManagement
{
    public static class SystemResources
    {
        ...
        public const string PROD_DATABASE_STRING = "Server=tcp:event-management.database.windows.net,1433;Initial Catalog=Event_Management_Application_db;Persist Security Info=False;User ID=sysadmin;Password=event_management123!;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";  
